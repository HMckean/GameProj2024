...
@onready var gun_anim2 = $Head/Camera3D/gun2/AnimationPlayer
@onready var gun_barrel2 = $Head/Camera3D/gun2/RayCast3D
@onready var gun2 = $Head/Camera3D/gun2

func _ready():
	Input.set_mouse_mode(Input.MOUSE_MODE_CAPTURED)
	Global.connect("harder", _on_harder)
...
#headbob
	...
	if Input.is_action_pressed("shoot"):
		...
		if !gun_anim2.is_playing() and gun2.visible:
